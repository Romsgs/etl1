...
fetch_functions = {
    ...
    "fetch_and_normalize_specifyc_projects": lambda hub_Id, project_id, project_name: asyncio.run(
        fetch_and_normalize_specifyc_projects(hub_Id, project_id, project_name)
    ),
    ...
    "fetch_and_normalize_derivative_items_properties": lambda urnOfSource, guid: asyncio.run(
        fetch_and_normalize_derivative_items_properties(urnOfSource, guid)
    ),
}
